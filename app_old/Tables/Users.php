...
class Users extends AbstractTable
{
    public function for()
    {
        ...
        $query->defaultSort('clients.name')
            ->defaultSort('-users.created_at')
            ->allowedSorts(['clients.name', 'users.role', 'users.name', 'users.email', 'users.phone_number', 'users.start_active', 'users.end_active'])
            ->allowedFilters(['clients.name', 'users.role', 'users.name', 'users.email', 'users.phone_number', 'users.start_active', 'users.end_active', 'client_id', $globalSearch]);
