...
class Works extends AbstractTable
{
    ...
    public function for()
    {
        ...
        $query = QueryBuilder::for(Work::class)
            ->defaultSort('name')
        ...
        $processed = $paginator->getCollection()->map(function ($work) use (&$startingNumber) {
            $work->setAttribute('number', $startingNumber++);
            return $work;
        });
