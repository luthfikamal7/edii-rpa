        ...
        <div class="px-3 py-3 lg:px-5 lg:pl-3">
            <div class="flex items-center justify-between">
                ...
                <div class="flex items-center justify-start">
                    ...
                    <a href="/edii-rpa/public/dashboard" class="flex ml-2 md:mr-24">
                        <span class="self-center text-xl font-semibold sm:text-2xl whitespace-nowrap dark:text-white sm:inline-block md:hidden">
                            <img src="{{ asset('assets-login/images/Logo Athena.png') }}" style="width: 100%;">
                        </span>

                        <!-- HTML for non-mobile devices -->
                        <span class="self-center text-xl font-semibold sm:text-2xl whitespace-nowrap dark:text-white hidden md:inline-block">
                            <img src="{{ asset('assets-login/images/Logo Athena.png') }}" style="width: 150px;">
                        </span>
                    </a>
                </div>
