    ...
    <div class="p-4 sm:ml-48">
        ...
        <x-splade-table :for="$user">
            <x-splade-cell action as="$user">
                <x-splade-link href="{{ url('/master/user-access/'.$user->id) }}" class="text-green-600 hover:text-green-800">
                    Access
                </x-splade-link>
                <x-splade-link style="margin-left: 10px;" href="{{ url('/master/user/reset/'.$user->id) }}" class="text-red-600 hover:text-red-800">
                    Reset Password
                </x-splade-link>
