...
Route::middleware('splade')->group(function () {
    ...
    Route::middleware('auth')->group(function () {
        ...
        Route::get('/robotRunCekCode/{robot}', [Robot::class, 'cekCode'])->name('robot.run-check-code');
        ...
        Route::get('/robotGetLogDetail/{robot}', [Robot::class, 'getLogDetail'])->name('robot.getLogDetail');
        ...
        Route::group(['prefix' => '/master'], function () {
            ...
            Route::group(['prefix' => '/user'], function () {
                ...
                Route::get('/reset/{user}', [User::class, 'reset'])->name('master.user.reset');
